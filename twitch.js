...
;(function($) {
  ...
  // Returns Twitch stream object
  Twitch.stream = function(streamID, width, height) {
      if(!streamID) {
          throw new Error("You need to supply a StreamID.");
      }
      var width = width;
      var height = height;
      if(!width) {
      ...
      iframe.src = "http://player.twitch.tv/?channel=" + streamID;
      iframe.width = width;
